        ...
        <div class="container max-w-lg px-4 py-32 mx-auto text-left md:max-w-none md:text-center">
            ...
            <div class="flex flex-col items-center mt-12 text-center">
                <span class="relative inline-flex w-full md:w-auto">
                    <a href="#_" class="inline-flex items-center justify-center w-full px-8 py-4 text-base font-bold leading-6 text-white bg-red-700 border border-transparent md:w-auto hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-700 rounded-full">
                        Purchase Now
                    </a>
                ...
                <a href="#" class="mt-3 text-sm text-red-700">Learn More</a>
            </div>
        </div>
    ...
    <div class="max-w-5xl mx-auto">
        <div class="flex flex-col items-center md:flex-row">
            ...
            <div class="w-full space-y-5 md:w-3/5 md:pr-16">
                <p class="font-medium text-red-700 uppercase">Building Businesses</p>
            ...
            <div class="w-full mt-16 md:mt-0 md:w-2/5">
                <div class="relative z-10 h-auto p-8 py-10 overflow-hidden bg-white border-b-2 border-gray-300 shadow-2xl px-7 rounded-3xl">
                    ...
                    <input type="text" name="email" class="block w-full px-4 py-3 mb-4 border border-2 border-transparent border-gray-200 focus:ring focus:ring-red-700 focus:outline-none rounded-full" placeholder="Email address">
                    <input type="password" name="password" class="block w-full px-4 py-3 mb-4 border border-2 border-transparent border-gray-200 focus:ring focus:ring-red-700 focus:outline-none rounded-full" placeholder="Password">
                    <div class="block">
                        <button class="w-full px-3 py-4 font-medium text-white bg-red-700 rounded-full">Log Me In</button>
                    </div>
